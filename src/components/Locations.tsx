            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden">
              ...
              <div className="relative">
                ...
                <Swiper pagination={true}
                  ...
                  navigation={true}
                  hashNavigation={true}
                  className="mySwiper custom-swiper-second  ">
                  {location?.images?.map( ( item, index ) => (
                    ...
                    <SwiperSlide key={index}>
                      <div className="w-full h-72">
                        ...
                        />
                        <div className=" bg-gradient-to-t from-black/50 to-transparent z-10 absolute top-0 left-0 h-full w-full" />
                        <div className="absolute bottom-5 left-5 text-gray-200 z-40">
